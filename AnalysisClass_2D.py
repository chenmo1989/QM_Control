...
class AH_exp2D:
    ...
    def SWAP_fft(self, expt_dataset, to_plot = True, data_process_method = 'I'):
        ...
        fft_result = np.fft.fft(mean_subtracted_data[data_process_method].values, axis=axis_index_time)
        ...
        frequencies = np.fft.fftfreq(expt_dataset.coords[coord_key_time].size, d=sample_spacing) * 1E9 # GHz to Hz
